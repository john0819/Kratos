...
const file_realworld_v1_error_reason_proto_rawDesc = "" +
	...
	"\x0eUSER_NOT_FOUND\x10\x01B&Z$kratos-realworld/api/realworld/v1;v1b\x06proto3"

var (
	file_realworld_v1_error_reason_proto_rawDescOnce sync.Once
	file_realworld_v1_error_reason_proto_rawDescData []byte
)

func file_realworld_v1_error_reason_proto_rawDescGZIP() []byte {
	file_realworld_v1_error_reason_proto_rawDescOnce.Do(func() {
		file_realworld_v1_error_reason_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_realworld_v1_error_reason_proto_rawDesc), len(file_realworld_v1_error_reason_proto_rawDesc)))
	})
...
func file_realworld_v1_error_reason_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_realworld_v1_error_reason_proto_rawDesc), len(file_realworld_v1_error_reason_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
